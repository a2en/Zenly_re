...
/* renamed from: e.h.e.k */
public class C7629k {
    /* renamed from: a */
    public static File m18575a(Context context) {
    ...
    private static java.nio.ByteBuffer m18578a(java.io.File r7) {
        /*
        ...
        L_0x0025:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: p214e.p234h.p235e.C7629k.m18578a(java.io.File):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.nio.ByteBuffer m18577a(android.content.Context r7, android.os.CancellationSignal r8, android.net.Uri r9) {
        /*
        ...
        L_0x004f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p214e.p234h.p235e.C7629k.m18577a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }

    /* renamed from: a */
    public static ByteBuffer m18576a(Context context, Resources resources, int i) {
        File a = m18575a(context);
        if (a == null) {
            return null;
        }
        try {
            if (!m18580a(a, resources, i)) {
                return null;
            }
            ByteBuffer a2 = m18578a(a);
            a.delete();
            return a2;
        } finally {
            a.delete();
    ...
    /* renamed from: a */
    public static boolean m18581a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        m18579a((Closeable) fileOutputStream2);
                ...
                try {
                    ...
                    m18579a((Closeable) fileOutputStream);
                    StrictMode.setThreadPolicy(allowThreadDiskWrites);
                    return false;
                } catch (Throwable th) {
                    th = th;
    ...
    /* renamed from: a */
    public static boolean m18580a(File file, Resources resources, int i) {
        InputStream inputStream;
        try {
            inputStream = resources.openRawResource(i);
            try {
                boolean a = m18581a(file, inputStream);
                m18579a((Closeable) inputStream);
                return a;
            } catch (Throwable th) {
                th = th;
                m18579a((Closeable) inputStream);
    ...
    /* renamed from: a */
    public static void m18579a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
