...
import p214e.p244l.p245a.p246a.C7642a;
...
public class C1266c {
    /* renamed from: a */
    public static Interpolator m6040a(Context context, int i) throws NotFoundException {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m6041a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
    ...
    /* renamed from: a */
    private static Interpolator m6041a(Context context, Resources resources, Theme theme, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Interpolator fVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            fVar = new C1270f(context, asAttributeSet, xmlPullParser);
                        } else {
                            StringBuilder sb = new StringBuilder();
