...
class C1240m {
    ...
    /* renamed from: a */
    private static final boolean f4642a = (VERSION.SDK_INT >= 19);

    /* renamed from: b */
    private static final boolean f4643b = (VERSION.SDK_INT >= 18);

    /* renamed from: c */
    private static final boolean f4644c;
    ...
    /* renamed from: a */
    static View m5979a(ViewGroup viewGroup, View view, View view2) {
        Matrix matrix = new Matrix();
        matrix.setTranslate((float) (-view2.getScrollX()), (float) (-view2.getScrollY()));
        C1254y.m6014a(view, matrix);
        C1254y.m6016b(viewGroup, matrix);
        ...
        Bitmap a = m5978a(view, matrix, rectF, viewGroup);
        if (a != null) {
    ...
    private static android.graphics.Bitmap m5978a(android.view.View r9, android.graphics.Matrix r10, android.graphics.RectF r11, android.view.ViewGroup r12) {
        /*
            boolean r0 = f4642a
            r1 = 0
        ...
        L_0x00ab:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.transition.C1240m.m5978a(android.view.View, android.graphics.Matrix, android.graphics.RectF, android.view.ViewGroup):android.graphics.Bitmap");
    }

    /* renamed from: a */
    static Animator m5977a(Animator animator, Animator animator2) {
        if (animator == null) {
            return animator2;
        }
        if (animator2 == null) {
