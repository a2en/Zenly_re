...
public final class CancellationSignal {
    ...
    /* renamed from: b */
    private OnCancelListener f2631b;
    ...
    public void mo3155a() {
        /*
            r4 = this;
            monitor-enter(r4)
            boolean r0 = r4.f2630a     // Catch:{ all -> 0x003e }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r4)     // Catch:{ all -> 0x003e }
            return
        L_0x0007:
            r0 = 1
            r4.f2630a = r0     // Catch:{ all -> 0x003e }
            r4.f2633d = r0     // Catch:{ all -> 0x003e }
            androidx.core.os.CancellationSignal$OnCancelListener r0 = r4.f2631b     // Catch:{ all -> 0x003e }
            java.lang.Object r1 = r4.f2632c     // Catch:{ all -> 0x003e }
            monitor-exit(r4)     // Catch:{ all -> 0x003e }
            r2 = 0
        ...
        L_0x003e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.p004os.CancellationSignal.mo3155a():void");
    }

    /* renamed from: b */
    public boolean mo3157b() {
        boolean z;
        synchronized (this) {
            z = this.f2630a;
        }
    ...
    /* renamed from: a */
    public void mo3156a(OnCancelListener onCancelListener) {
        synchronized (this) {
            m2665c();
            if (this.f2631b != onCancelListener) {
                this.f2631b = onCancelListener;
                if (this.f2630a) {
