...
import androidx.appcompat.widget.C0288w;
...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new C7571a();
    private static final Class<?>[] sConstructorSignature = {Context.class, AttributeSet.class};
    private static final int[] sOnClickAttrs = {16843375};
    private final Object[] mConstructorArgs = new Object[2];

    /* renamed from: androidx.appcompat.app.AppCompatViewInflater$a */
    private static class C0121a implements OnClickListener {

        /* renamed from: e */
        private final View f357e;

        /* renamed from: f */
        private final String f358f;

        /* renamed from: g */
        private Method f359g;

        /* renamed from: h */
        private Context f360h;

        public C0121a(View view, String str) {
            this.f357e = view;
            this.f358f = str;
        }

        /* renamed from: a */
        private void m337a(Context context, String str) {
            String str2;
            while (context != null) {
                try {
                    if (!context.isRestricted()) {
                        Method method = context.getClass().getMethod(this.f358f, new Class[]{View.class});
                        if (method != null) {
                            this.f359g = method;
                            this.f360h = context;
                            return;
            ...
            int id = this.f357e.getId();
            if (id == -1) {
                str2 = "";
            } else {
                StringBuilder sb = new StringBuilder();
                sb.append(" with id '");
                sb.append(this.f357e.getContext().getResources().getResourceEntryName(id));
                sb.append("'");
                str2 = sb.toString();
            }
            ...
            sb2.append(this.f357e.getClass());
            sb2.append(str2);
        ...
        public void onClick(View view) {
            if (this.f359g == null) {
                m337a(this.f357e.getContext(), this.f358f);
            }
            try {
                this.f359g.invoke(this.f360h, new Object[]{view});
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT < 15 || ViewCompat.m2871x(view)) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, sOnClickAttrs);
            String string = obtainStyledAttributes.getString(0);
            if (string != null) {
                view.setOnClickListener(new C0121a(view, string));
            }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C7530j.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C7530j.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(C7530j.View_theme, 0);
            if (resourceId != 0) {
        ...
        obtainStyledAttributes.recycle();
        if (resourceId != 0) {
            return (!(context instanceof C0143b) || ((C0143b) context).mo615a() != resourceId) ? new C0143b(context, resourceId) : context;
        }
        return context;
    }
    ...
    public final View createView(View view, String str, Context context, AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z4) {
            context2 = C0288w.m1192b(context2);
        }
        char c = 65535;
        switch (str.hashCode()) {
            case -1946472170:
