...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView {
    ...
    /* renamed from: e */
    private final C0248d f851e;

    /* renamed from: f */
    private final C0244c f852f;

    /* renamed from: g */
    private final C0259k f853g;
    ...
    public void drawableStateChanged() {
        ...
        C0244c cVar = this.f852f;
        if (cVar != null) {
            cVar.mo1866a();
        }
        C0259k kVar = this.f853g;
        if (kVar != null) {
            kVar.mo1921a();
        }
    }
    ...
    public AppCompatCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C7521a.checkboxStyle);
    }

    public AppCompatCheckBox(Context context, AttributeSet attributeSet, int i) {
        super(C0288w.m1192b(context), attributeSet, i);
        this.f851e = new C0248d(this);
        this.f851e.mo1887a(attributeSet, i);
        this.f852f = new C0244c(this);
        this.f852f.mo1871a(attributeSet, i);
        this.f853g = new C0259k(this);
        this.f853g.mo1928a(attributeSet, i);
    }
