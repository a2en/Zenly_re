...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: a */
    private boolean m790a(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C7526f.topPanel) {
                    view = childAt;
                } else if (id == C7526f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C7526f.contentPanel && id != C7526f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.view.ViewCompat.m2862o(r17)
            int r2 = androidx.core.view.C0641c.m3002a(r2, r3)
            r2 = r2 & 7
            r3 = 1
    ...
    /* renamed from: a */
    private static int m789a(View view) {
        int p = ViewCompat.m2863p(view);
        if (p > 0) {
            return p;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m789a(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
