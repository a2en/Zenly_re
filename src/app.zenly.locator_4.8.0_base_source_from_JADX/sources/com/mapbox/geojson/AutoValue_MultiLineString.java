...
final class AutoValue_MultiLineString extends C$AutoValue_MultiLineString {
    ...
    public static final class GsonTypeAdapter extends C11138i<MultiLineString> {
        ...
        public MultiLineString read(C11262a aVar) throws IOException {
            String str = null;
        ...
        public void write(C11265c cVar, MultiLineString multiLineString) throws IOException {
            ...
            if (multiLineString.type() == null) {
                ...
                iVar.write(cVar, multiLineString.type());
            }
            cVar.mo32599b("bbox");
            if (multiLineString.bbox() == null) {
                ...
                iVar2.write(cVar, multiLineString.bbox());
            }
            ...
            if (multiLineString.coordinates() == null) {
                ...
                iVar3.write(cVar, multiLineString.coordinates());
            }
            cVar.mo32602d();
        }
    }

    AutoValue_MultiLineString(String str, BoundingBox boundingBox, List<List<Point>> list) {
