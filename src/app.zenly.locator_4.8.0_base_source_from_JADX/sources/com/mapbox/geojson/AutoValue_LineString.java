...
final class AutoValue_LineString extends C$AutoValue_LineString {
    ...
    public static final class GsonTypeAdapter extends C11138i<LineString> {
        ...
        public LineString read(C11262a aVar) throws IOException {
            String str = null;
        ...
        public void write(C11265c cVar, LineString lineString) throws IOException {
            if (lineString == null) {
                cVar.mo32606h();
                return;
            }
            ...
            if (lineString.type() == null) {
                ...
                iVar.write(cVar, lineString.type());
            }
            cVar.mo32599b("bbox");
            if (lineString.bbox() == null) {
                ...
                iVar2.write(cVar, lineString.bbox());
            }
            ...
            if (lineString.coordinates() == null) {
                ...
                iVar3.write(cVar, lineString.coordinates());
            }
            cVar.mo32602d();
        }
    }

    AutoValue_LineString(String str, BoundingBox boundingBox, List<Point> list) {
