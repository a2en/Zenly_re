...
final class AutoValue_MultiPolygon extends C$AutoValue_MultiPolygon {
    ...
    public static final class GsonTypeAdapter extends C11138i<MultiPolygon> {
        private volatile C11138i<BoundingBox> boundingBox_adapter;
        private final C11125d gson;
        private volatile C11138i<List<List<List<Point>>>> list__list__list__point_adapter;
        ...
        public MultiPolygon read(C11262a aVar) throws IOException {
            String str = null;
            ...
            while (aVar.mo32579g()) {
                ...
                if (aVar.peek() == C11264b.NULL) {
                    ...
                    if (c == 0) {
                        ...
                        C11138i<List<List<List<Point>>>> iVar3 = this.list__list__list__point_adapter;
                        if (iVar3 == null) {
                            iVar3 = this.gson.mo32448a(C11261a.getParameterized(List.class, C11261a.getParameterized(List.class, C11261a.getParameterized(List.class, Point.class).getType()).getType()));
                            this.list__list__list__point_adapter = iVar3;
                        }
        ...
        public void write(C11265c cVar, MultiPolygon multiPolygon) throws IOException {
            ...
            if (multiPolygon.type() == null) {
                ...
                iVar.write(cVar, multiPolygon.type());
            }
            cVar.mo32599b("bbox");
            if (multiPolygon.bbox() == null) {
                ...
                iVar2.write(cVar, multiPolygon.bbox());
            }
            ...
            if (multiPolygon.coordinates() == null) {
                ...
                iVar3.write(cVar, multiPolygon.coordinates());
            }
            cVar.mo32602d();
        }
    }

    AutoValue_MultiPolygon(String str, BoundingBox boundingBox, List<List<List<Point>>> list) {
