...
/* renamed from: com.mapbox.android.telemetry.i */
class C11351i {

    /* renamed from: a */
    static final Map<String, List<String>> f29432a = new C11352a();

    /* renamed from: com.mapbox.android.telemetry.i$a */
    static class C11352a extends HashMap<String, List<String>> {

        /* renamed from: com.mapbox.android.telemetry.i$a$a */
        class C11353a extends ArrayList<String> {
            C11353a(C11352a aVar) {
                add("gakY+fylqW6kp6piqnaQNLZFzT8HlhzP5lsGJk5WguE=");
                String str = "5kJvNEMw0KjrCAu7eXY5HZdvyCS13BbA0VJG1RSP91w=";
                add(str);
                String str2 = "r/mIkG3eEpVdm+u/ko/cwxzOMo1bk4TyHIlByibiA5E=";
                add(str2);
        ...
        C11352a() {
            put("events.mapbox.cn", new C11353a(this));
        }
    }
}
