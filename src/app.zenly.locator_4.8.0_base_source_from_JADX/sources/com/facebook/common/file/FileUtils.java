...
public class FileUtils {
    ...
    /* renamed from: a */
    public static void m23242a(File file) throws CreateDirectoryException {
        if (file.exists()) {
            if (!file.isDirectory()) {
                if (!file.delete()) {
    ...
    /* renamed from: a */
    public static void m23243a(File file, File file2) throws RenameException {
        C9536j.m23271a(file);
        C9536j.m23271a(file2);
        file2.delete();
