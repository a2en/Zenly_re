...
/* renamed from: com.facebook.imagepipeline.cache.n */
public class C9693n implements CacheTrimStrategy {

    /* renamed from: com.facebook.imagepipeline.cache.n$a */
    static /* synthetic */ class C9694a {

        /* renamed from: a */
        static final /* synthetic */ int[] f25326a = new int[C9545a.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f25326a = r0
                int[] r0 = f25326a     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f25326a     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f25326a     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f25326a     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r0 = f25326a     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.cache.C9693n.C9694a.<clinit>():void");
        }
    }

    public double getTrimRatio(C9545a aVar) {
        int i = C9694a.f25326a[aVar.ordinal()];
        if (i == 1) {
            return 0.0d;
        }
        if (i == 2 || i == 3 || i == 4 || i == 5) {
        ...
        C9543a.m23325d("NativeMemoryCacheTrimStrategy", "unknown trim type: %s", aVar);
        return 0.0d;
    }
}
