...
public final class JsonArray extends JsonElement implements Iterable<JsonElement> {
    ...
    public void add(Boolean bool) {
        this.elements.add(bool == null ? C11133f.f28848a : new JsonPrimitive(bool));
    }
    ...
    public void add(Character ch) {
        this.elements.add(ch == null ? C11133f.f28848a : new JsonPrimitive(ch));
    }
    ...
    public void add(Number number) {
        this.elements.add(number == null ? C11133f.f28848a : new JsonPrimitive(number));
    }

    public void add(String str) {
        this.elements.add(str == null ? C11133f.f28848a : new JsonPrimitive(str));
    }
