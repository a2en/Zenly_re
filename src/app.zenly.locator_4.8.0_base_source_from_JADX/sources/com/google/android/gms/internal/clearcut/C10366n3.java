...
abstract class C10366n3 {
    C10366n3() {
    }

    /* renamed from: b */
    static void m26352b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
    ...
    /* renamed from: a */
    public abstract int mo28067a(int i, byte[] bArr, int i2, int i3);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract int mo28068a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract void mo28069a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final boolean mo28070a(byte[] bArr, int i, int i2) {
        return mo28067a(0, bArr, i, i2) == 0;
    }
}
