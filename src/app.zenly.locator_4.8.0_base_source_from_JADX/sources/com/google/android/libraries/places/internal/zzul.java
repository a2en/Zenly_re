...
interface zzul {
    ...
    void zza(int i, zzqa zzqa) throws IOException;

    <K, V> void zza(int i, zzsd<K, V> zzsd, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzsz zzsz) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzsz zzsz) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzsz zzsz) throws IOException;

    void zzb(int i, List<zzqa> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzsz zzsz) throws IOException;
