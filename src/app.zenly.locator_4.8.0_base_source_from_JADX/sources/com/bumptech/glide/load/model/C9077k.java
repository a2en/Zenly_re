...
public class C9077k implements Encoder<InputStream> {

    /* renamed from: a */
    private final ArrayPool f23638a;

    public C9077k(ArrayPool arrayPool) {
        this.f23638a = arrayPool;
    }
    ...
    public boolean encode(java.io.InputStream r5, java.io.File r6, com.bumptech.glide.load.C9011f r7) {
        /*
            r4 = this;
            java.lang.String r7 = "StreamEncoder"
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r0 = r4.f23638a
        ...
        L_0x0042:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r5 = r4.f23638a
            r5.put(r0)
            return r1
        L_0x0048:
        ...
        L_0x004d:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r6 = r4.f23638a
            r6.put(r0)
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.model.C9077k.encode(java.io.InputStream, java.io.File, com.bumptech.glide.load.f):boolean");
    }
}
