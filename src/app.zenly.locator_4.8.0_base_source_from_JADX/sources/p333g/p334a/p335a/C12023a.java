package p333g.p334a.p335a;

import java.security.DigestException;
import java.security.MessageDigest;

/* renamed from: g.a.a.a */
public final class C12023a extends MessageDigest implements Cloneable {
    ...
    /* renamed from: g */
    private byte[] f31315g = new byte[64];
    ...
    /* renamed from: a */
    public void mo35651a() {
        this.f31316h = 1732584193;
        this.f31317i = -271733879;
        this.f31318j = -1732584194;
        this.f31319k = 271733878;
    }

    public Object clone() throws CloneNotSupportedException {
        C12023a aVar = (C12023a) super.clone();
        aVar.f31315g = (byte[]) this.f31315g.clone();
        return aVar;
    }
    ...
    public int engineDigest(byte[] r17, int r18, int r19) throws java.security.DigestException {
        ...
        L_0x0196:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p333g.p334a.p335a.C12023a.engineDigest(byte[], int, int):int");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final void m31674a(byte[] r28, int r29) {
        /*
            r27 = this;
            r0 = r27
            int r1 = r0.f31317i
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p333g.p334a.p335a.C12023a.m31674a(byte[], int):void");
    }
    ...
    public void engineUpdate(byte[] bArr, int i, int i2) {
        ...
        this.f31313e += (long) i2;
        int i3 = this.f31314f;
        if (i3 > 0 && i3 + i2 >= 64) {
            int i4 = 64 - i3;
            System.arraycopy(bArr, i, this.f31315g, i3, i4);
            byte[] bArr2 = this.f31315g;
            this.f31314f = 0;
            m31674a(bArr2, 0);
            i += i4;
        ...
        if (i2 > 0) {
            System.arraycopy(bArr, i, this.f31315g, this.f31314f, i2);
            this.f31314f += i2;
        }
    }
}
