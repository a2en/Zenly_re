...
/* renamed from: app.zenly.locator.m */
public final class C3892m {
    ...
    public static final int[] AnimatedTextView = {R.attr.textAppearance, R.attr.textColor, R.attr.textSize};
    public static final int AnimatedTextView_textAppearance = 0;
    ...
    public static final int[] BatteryView = {R.attr.capsuleBackgroundColor, R.attr.capsuleCornerRadius, R.attr.capsuleProgressColors, R.attr.foregroundColors, R.attr.minHeight, R.attr.minWidth};
    public static final int BatteryView_capsuleBackgroundColor = 0;
    public static final int BatteryView_capsuleCornerRadius = 1;
    public static final int BatteryView_capsuleProgressColors = 2;
    public static final int BatteryView_foregroundColors = 3;
    public static final int BatteryView_minHeight = 4;
    public static final int BatteryView_minWidth = 5;
    ...
    public static final int[] CameraView = {16843038, R.attr.ckCropOutput, R.attr.ckDoubleTapToToggleFacing, R.attr.ckFacing, R.attr.ckFlash, R.attr.ckFocus, R.attr.ckJpegQuality, R.attr.ckLockVideoAspectRatio, R.attr.ckMethod, R.attr.ckPermissions, R.attr.ckPinchToZoom, R.attr.ckVideoBitRate, R.attr.ckVideoQuality, R.attr.ckZoom};
    ...
    public static final int[] CapsuleTextView = {R.attr.color};
    public static final int CapsuleTextView_color = 0;
    public static final int[] CardBackgroundView = {R.attr.mirrorGradient, R.attr.pattern, R.attr.patternTint, R.attr.shape, R.attr.shapeTintEnd, R.attr.shapeTintStart, R.attr.shineHeight, R.attr.shineTint, R.attr.thickness, R.attr.thicknessTint};
    public static final int CardBackgroundView_mirrorGradient = 0;
    public static final int CardBackgroundView_pattern = 1;
    public static final int CardBackgroundView_patternTint = 2;
    public static final int CardBackgroundView_shape = 3;
    public static final int CardBackgroundView_shapeTintEnd = 4;
    public static final int CardBackgroundView_shapeTintStart = 5;
    public static final int CardBackgroundView_shineHeight = 6;
    public static final int CardBackgroundView_shineTint = 7;
    public static final int CardBackgroundView_thickness = 8;
    public static final int CardBackgroundView_thicknessTint = 9;
    public static final int[] CardLayout = {16843071, 16843072, R.attr.autoScale, R.attr.defaultMeasure};
    public static final int[] CardLayout_Layout = {R.attr.layout_elevationShift};
    public static final int CardLayout_Layout_layout_elevationShift = 0;
    public static final int CardLayout_android_minHeight = 1;
    public static final int CardLayout_android_minWidth = 0;
    public static final int CardLayout_autoScale = 2;
    public static final int CardLayout_defaultMeasure = 3;
    public static final int[] CardShineImageView = {R.attr.tiltShift};
    public static final int CardShineImageView_tiltShift = 0;
    ...
    public static final int[] CircleProgressView = {R.attr.circleBackgroundColor, R.attr.circleBorderColor, R.attr.circleProgressColor, R.attr.circleProgressStyle, R.attr.circleStrokeSize, R.attr.inverted, R.attr.max, R.attr.progress};
    public static final int CircleProgressView_circleBackgroundColor = 0;
    public static final int CircleProgressView_circleBorderColor = 1;
    public static final int CircleProgressView_circleProgressColor = 2;
    public static final int CircleProgressView_circleProgressStyle = 3;
    public static final int CircleProgressView_circleStrokeSize = 4;
    public static final int CircleProgressView_inverted = 5;
    public static final int CircleProgressView_max = 6;
    ...
    public static final int[] Darkable = {R.attr.state_dark};
    public static final int Darkable_state_dark = 0;
    ...
    public static final int[] EmojiGridView = {R.attr.emojisAlpha, R.attr.emojisBlur, R.attr.emojisGrey};
    public static final int EmojiGridView_emojisAlpha = 0;
    public static final int EmojiGridView_emojisBlur = 1;
    public static final int EmojiGridView_emojisGrey = 2;
    public static final int[] EmptyView = {R.attr.actionImportance, R.attr.actionText, R.attr.src, R.attr.subtitle, R.attr.subtitleColor, R.attr.title, R.attr.titleColor};
    public static final int EmptyView_actionImportance = 0;
    public static final int EmptyView_actionText = 1;
    public static final int EmptyView_src = 2;
    public static final int EmptyView_subtitle = 3;
    public static final int EmptyView_subtitleColor = 4;
    public static final int EmptyView_title = 5;
    public static final int EmptyView_titleColor = 6;
    ...
    public static final int[] HeaderView = {R.attr.mainLabelBrightModeColor, R.attr.mainLabelDarkModeColor, R.attr.metaBrightModeColor, R.attr.metaDarkModeColor, R.attr.streetBrightModeColor, R.attr.streetDarkModeColor};
    public static final int HeaderView_mainLabelBrightModeColor = 0;
    public static final int HeaderView_mainLabelDarkModeColor = 1;
    public static final int HeaderView_metaBrightModeColor = 2;
    public static final int HeaderView_metaDarkModeColor = 3;
    public static final int HeaderView_streetBrightModeColor = 4;
    public static final int HeaderView_streetDarkModeColor = 5;
    public static final int[] ImageButtonStyleable = {16842964, 16843041};
    public static final int ImageButtonStyleable_android_background = 0;
    public static final int ImageButtonStyleable_android_tint = 1;
    ...
    public static final int LinearLayout_Layout_android_layout_gravity = 0;
    public static final int LinearLayout_Layout_android_layout_height = 2;
    public static final int LinearLayout_Layout_android_layout_weight = 3;
    public static final int LinearLayout_Layout_android_layout_width = 1;
    ...
    public static final int[] MapCapsuleView = {R.attr.iconBackground, R.attr.iconSrc, R.attr.iconTint, R.attr.text, R.attr.textColor, R.attr.textEndIconSrc, R.attr.textIconTint, R.attr.textStartIconSrc, R.attr.title, R.attr.titleColor};
    public static final int MapCapsuleView_iconBackground = 0;
    public static final int MapCapsuleView_iconSrc = 1;
    public static final int MapCapsuleView_iconTint = 2;
    public static final int MapCapsuleView_text = 3;
    public static final int MapCapsuleView_textColor = 4;
    public static final int MapCapsuleView_textEndIconSrc = 5;
    public static final int MapCapsuleView_textIconTint = 6;
    public static final int MapCapsuleView_textStartIconSrc = 7;
    public static final int MapCapsuleView_title = 8;
    public static final int MapCapsuleView_titleColor = 9;
    ...
    public static final int[] MinimumRatioFrameLayout = {R.attr.minimumRatio};
    public static final int MinimumRatioFrameLayout_minimumRatio = 0;
    ...
    public static final int[] NotifyMeButtonView = {R.attr.subtext, R.attr.text};
    public static final int NotifyMeButtonView_subtext = 0;
    public static final int NotifyMeButtonView_text = 1;
    ...
    public static final int[] OutlinedTextView = {R.attr.shadowColor, R.attr.shadowDx, R.attr.shadowDy, R.attr.shadowRadius, R.attr.strokeColor};
    public static final int OutlinedTextView_shadowColor = 0;
    public static final int OutlinedTextView_shadowDx = 1;
    public static final int OutlinedTextView_shadowDy = 2;
    public static final int OutlinedTextView_shadowRadius = 3;
    public static final int OutlinedTextView_strokeColor = 4;
    ...
    public static final int[] ScreenBar = {R.attr.actionIcon, R.attr.actionText, R.attr.singleLine, R.attr.subtitle, R.attr.title};
    public static final int[] ScreenBarLayout = {R.attr.collapsedHeight, R.attr.liftOnScroll, R.attr.liftOnScrollTargetViewId};
    public static final int ScreenBarLayout_collapsedHeight = 0;
    public static final int ScreenBarLayout_liftOnScroll = 1;
    public static final int ScreenBarLayout_liftOnScrollTargetViewId = 2;
    public static final int ScreenBar_actionIcon = 0;
    public static final int ScreenBar_actionText = 1;
    public static final int ScreenBar_singleLine = 2;
    public static final int ScreenBar_subtitle = 3;
    public static final int ScreenBar_title = 4;
    public static final int[] ScrimInsetsFrameLayout = {R.attr.insetForeground};
    public static final int ScrimInsetsFrameLayout_insetForeground = 0;
    public static final int[] ScrollingViewBehavior_Layout = {R.attr.behavior_overlapTop};
    public static final int ScrollingViewBehavior_Layout_behavior_overlapTop = 0;
    public static final int[] SearchBar = {R.attr.cancelText, R.attr.hint, R.attr.imeOptions, R.attr.inputType, R.attr.text};
    public static final int SearchBar_cancelText = 0;
    public static final int SearchBar_hint = 1;
    public static final int SearchBar_imeOptions = 2;
    public static final int SearchBar_inputType = 3;
    public static final int SearchBar_text = 4;
    ...
    public static final int[] SegmentedBar = {R.attr.items, R.attr.selectedIndex};
    public static final int SegmentedBar_items = 0;
    public static final int SegmentedBar_selectedIndex = 1;
    ...
    public static final int[] SimpleInAppNotificationView = {R.attr.iconTint, R.attr.margin, R.attr.messageAppearance, R.attr.messageColor, R.attr.titleAppearance, R.attr.titleColor};
    public static final int SimpleInAppNotificationView_iconTint = 0;
    public static final int SimpleInAppNotificationView_margin = 1;
    public static final int SimpleInAppNotificationView_messageAppearance = 2;
    public static final int SimpleInAppNotificationView_messageColor = 3;
    public static final int SimpleInAppNotificationView_titleAppearance = 4;
    public static final int SimpleInAppNotificationView_titleColor = 5;
    public static final int[] SmoothRectDrawable = {R.attr.dither, R.attr.tint, R.attr.tintMode, R.attr.visible};
    public static final int[] SmoothRectDrawableCorners = {R.attr.bottomLeftRadius, R.attr.bottomRightRadius, R.attr.radius, R.attr.radiusRatio, R.attr.topLeftRadius, R.attr.topRightRadius};
    public static final int SmoothRectDrawableCorners_bottomLeftRadius = 0;
    public static final int SmoothRectDrawableCorners_bottomRightRadius = 1;
    public static final int SmoothRectDrawableCorners_radius = 2;
    public static final int SmoothRectDrawableCorners_radiusRatio = 3;
    public static final int SmoothRectDrawableCorners_topLeftRadius = 4;
    public static final int SmoothRectDrawableCorners_topRightRadius = 5;
    public static final int[] SmoothRectDrawableGradient = {R.attr.angle, R.attr.centerColor, R.attr.centerX, R.attr.centerY, R.attr.endColor, R.attr.gradientRadius, R.attr.startColor, R.attr.type, R.attr.useLevel};
    public static final int SmoothRectDrawableGradient_angle = 0;
    public static final int SmoothRectDrawableGradient_centerColor = 1;
    public static final int SmoothRectDrawableGradient_centerX = 2;
    public static final int SmoothRectDrawableGradient_centerY = 3;
    public static final int SmoothRectDrawableGradient_endColor = 4;
    public static final int SmoothRectDrawableGradient_gradientRadius = 5;
    public static final int SmoothRectDrawableGradient_startColor = 6;
    public static final int SmoothRectDrawableGradient_type = 7;
    public static final int SmoothRectDrawableGradient_useLevel = 8;
    public static final int[] SmoothRectDrawablePadding = {R.attr.bottom, R.attr.left, R.attr.right, R.attr.top};
    public static final int SmoothRectDrawablePadding_bottom = 0;
    public static final int SmoothRectDrawablePadding_left = 1;
    public static final int SmoothRectDrawablePadding_right = 2;
    public static final int SmoothRectDrawablePadding_top = 3;
    public static final int[] SmoothRectDrawableSize = {R.attr.height, R.attr.width};
    public static final int SmoothRectDrawableSize_height = 0;
    public static final int SmoothRectDrawableSize_width = 1;
    public static final int[] SmoothRectDrawableSolid = {R.attr.color};
    public static final int SmoothRectDrawableSolid_color = 0;
    public static final int[] SmoothRectDrawableStroke = {R.attr.color, R.attr.dashGap, R.attr.dashWidth, R.attr.width};
    public static final int SmoothRectDrawableStroke_color = 0;
    public static final int SmoothRectDrawableStroke_dashGap = 1;
    public static final int SmoothRectDrawableStroke_dashWidth = 2;
    public static final int SmoothRectDrawableStroke_width = 3;
    public static final int SmoothRectDrawable_dither = 0;
    public static final int SmoothRectDrawable_tint = 1;
    public static final int SmoothRectDrawable_tintMode = 2;
    public static final int SmoothRectDrawable_visible = 3;
    ...
    public static final int[] StatefulLayout = {R.attr.hidden_visibility};
    public static final int[] StatefulLayout_Layout = {R.attr.layout_isLoader};
    public static final int StatefulLayout_Layout_layout_isLoader = 0;
    public static final int StatefulLayout_hidden_visibility = 0;
    ...
    public static final int[] SwitchMenuItem = {R.attr.switchDescription, R.attr.switchTitle};
    public static final int SwitchMenuItem_switchDescription = 0;
    public static final int SwitchMenuItem_switchTitle = 1;
    ...
    public static final int[] TextMenuItem = {R.attr.accessoryIcon, R.attr.accessoryText, R.attr.description, R.attr.title};
    public static final int TextMenuItem_accessoryIcon = 0;
    public static final int TextMenuItem_accessoryText = 1;
    public static final int TextMenuItem_description = 2;
    public static final int TextMenuItem_title = 3;
    public static final int[] TextView = {16842804};
    public static final int[] TextViewStyleable = {16842904, 16842964, R.attr.drawableTint};
    public static final int TextViewStyleable_android_background = 1;
    public static final int TextViewStyleable_android_textColor = 0;
    public static final int TextViewStyleable_drawableTint = 2;
    ...
    public static final int f10305xe3a779d9 = 25;
