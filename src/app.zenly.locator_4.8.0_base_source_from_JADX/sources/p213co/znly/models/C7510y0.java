...
/* renamed from: co.znly.models.y0 */
/* synthetic */ class C7510y0 {

    /* renamed from: a */
    static final /* synthetic */ int[] f18869a = new int[MethodToInvoke.values().length];
    ...
    static {
        /*
            ...
            int[] r0 = new int[r0]
            f18869a = r0
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x0014 }
        ...
        L_0x0014:
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x001f }
        ...
        L_0x001f:
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x002a }
        ...
        L_0x002a:
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x0035 }
        ...
        L_0x0035:
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x0040 }
        ...
        L_0x0040:
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x004b }
        ...
        L_0x004b:
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x0056 }
        ...
        L_0x0056:
            int[] r0 = f18869a     // Catch:{ NoSuchFieldError -> 0x0062 }
        ...
        L_0x0062:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p213co.znly.models.C7510y0.<clinit>():void");
    }
}
